...
#define bsg_print_stat_start(tag) do { if (__bsg_id == 0) bsg_print_stat(((bsg_PRINT_STAT_START_VAL) + (tag))); } while(0)
#define bsg_print_stat_end(tag)   do { if (__bsg_id == 0) bsg_print_stat(((bsg_PRINT_STAT_END_VAL)   + (tag))); } while(0)
